...
export const swipeRight = async (req, res) => {
	try {
        ...
        if (!currentUser.likes.includes(likedUserId)) {
            ...
            // Convert likedUser.likes to strings for comparison
            const likedUserLikes = likedUser.likes.map(id => id.toString());
            if (likedUserLikes.includes(currentUser._id.toString())) {
